...
from tasks.email_settings import *
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'tasks.custom_processors.tag_processor',
                'tasks.custom_processors.all_db_tags'
            ],
        },
    },
]
...
LOGOUT_REDIRECT_URL = 'tasks:all_tasks'
LOGIN_REDIRECT_URL = '/'
...
AUTHENTICATION_BACKENDS = [
    ...
    'tasks.custom_backends.EmailBackend',
